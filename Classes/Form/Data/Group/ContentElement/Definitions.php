<?php
namespace TYPO3\CMS\Wireframe\Form\Data\Group\ContentElement;
...
/**
 * A data provider group for content element definitions
 */
class Definitions implements FormDataGroupInterface
{
    /**
     * Compile form data
     *
    ...
    {
        $dataProvider = $GLOBALS['TYPO3_CONF_VARS']['SYS']['formEngine']['formDataGroup']['contentElementDefinitions'];
